...
const ProfilePart = () => {
  return (
    <div className='w-[25%]  h-[400px]   pt-[30px] rounded-2xl  '>
      <div className="w-full  h-full bg-white  rounded-2xl  ">
        <div className="w-full h-[30%] rounded-2xl bg-cover bg-center bg-no-repeat bg-[url(assets/cover.jpg)]">
        </div>
        {/* Profile__pic */}
        <div className="relative ">
          <img className='w-[60px] h-[60px] rounded-full absolute top-[-28px] left-[23px]    ' src={profile} alt="" />
        </div>
        {/* Name__part */}
